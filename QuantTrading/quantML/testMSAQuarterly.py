...
def printSampleDataFrameMonthly(tickerSymbol):
    ...
    #three quarter average = 9 month average    
    quarterlyAvgs = closingPrices.rolling(window=9).mean()
    
    validMonthlyAvgs = quarterlyAvgs.dropna()
    print("---- 3 Quarter Average Prices ------ ")
    ...
    plt.xlabel('Date')
    plt.ylabel('monthly ranges vs. 3 Quarters Average')
